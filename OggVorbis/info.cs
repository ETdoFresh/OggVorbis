...
namespace OggVorbis
{
    ...
    {
        public const string GENERAL_VENDOR_STRING = "Xiph.Org libVorbis 1.3.6";
        public const string ENCODE_VENDOR_STRING = "Xiph.Org libVorbis I 20180316 (Now 100% fewer shells)";

        /* helpers */

        public static void _v_writestring(oggpack_buffer o, string s, int bytes)
        {
        ...
        public static void _v_readstring(oggpack_buffer o, byte[] buf, long bytes)
        {
            while (bytes--)
            {
...
namespace OggVorbis
{
    public partial class info
    {
        public static void vorbis_comment_clear(vorbis_comment vc)
        {
            ...
            {
                for (i = 0; i < vc.comments; i++)
                    if (vc.user_comments[i] != null) _ogg_free(vc.user_comments[i]);
                _ogg_free(vc.user_comments);
            }
            if (vc.comment_lengths != null) _ogg_free(vc.comment_lengths);
            if (vc.vendor != null) _ogg_free(vc.vendor);
            //memset(vc, 0, sizeof(*vc));
            //}
        }
        ...
        public static long vorbis_info_blocksize(vorbis_info vi, int zo)
        {
            codec_setup_info ci = vi.codec_setup;
            return ci.blocksizes[zo];
        }
        ...
        public static int _vorbis_unpack_info(vorbis_info vi, oggpack_buffer opb)
        {
            ...
            ci.blocksizes[0] = 1 << (int)oggpack_read(opb, 4);
            ci.blocksizes[1] = 1 << (int)oggpack_read(opb, 4);
        ...
        {
            long i;
            long vendorlen = oggpack_read(opb, 32);
